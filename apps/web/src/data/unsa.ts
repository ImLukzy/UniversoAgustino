...
export const UNSA_CAREERS: UnsaCareer[] = [
  { key: "ENFERMERIA", label: "Enfermería", faculty: "Facultad de Enfermería", color: "#0d9488", soft: "#ccfbf1" },
  ...
  { key: "BIOLOGIA", label: "Biología", faculty: "Fac. de Ciencias Biológicas", color: "#059669", soft: "#d1fae5" },
  { key: "DERECHO", label: "Derecho", faculty: "Facultad de Derecho", color: "#b45309", soft: "#fef3c7" },
  { key: "EDUCACION", label: "Educación", faculty: "Facultad de Educación", color: "#0284c7", soft: "#e0f2fe" },
  ...
  { key: "AGRONOMIA", label: "Agronomía", faculty: "Fac. de Agronomía", color: "#65a30d", soft: "#ecfccb" },
...
export function careerColor(key?: string | null): string {
  return careerOf(key)?.color ?? "#0d9488";
}
